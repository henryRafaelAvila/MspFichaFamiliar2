...
public enum TABLES {
    ...
    CANTON("canton",Canton.class,"CREATE TABLE canton (_id INTEGER PRIMARY KEY  NOT NULL ,id_provincia Integer NOT NULL  DEFAULT (null) ,cod_cant VARCHAR NOT NULL ,descripcion VARCHAR NOT NULL )"),
    PARROQUIA("parroquia",Parroquia.class,"CREATE TABLE parroquia (_id INTEGER PRIMARY KEY  NOT NULL , id_canton INTEGER NOT NULL , id_distrito INTEGER NOT NULL , cod_parr VARCHAR NOT NULL , descripcion VARCHAR NOT NULL )"),
