...
public enum TABLES {
    ...
    CAUSA_MOTALIDAD ("causa_mortalidad",CausaMortalidad.class,"CREATE TABLE causa_mortalidad (_id INTEGER PRIMARY KEY  NOT NULL , cod_cau_mor VARCHAR NOT NULL , descripcion VARCHAR NOT NULL )"),
    ...
    FORMULARIO("formulario", Formulario.class,"CREATE TABLE formulario(_id INTEGER PRIMARY KEY  AUTOINCREMENT NOT NULL,codigo INTEGER,id_mat_pis integer,id_mat_par integer,id_pro_agudd integer,id_est_tech integer,id_rec_agu integer,id_cond_ocup integer,id_tra_agu integer,id_via_acc integer,id_comb_coc integer,id_tip_trans integer,id_est_pis integer,id_eli_bas integer,id_eli_agu integer,id_tip_viv integer,id_ubi_let integer,id_unid_oper integer,id_mat_tec integer,fecha_visita date NOT NULL,tiem_viv_meses integer,tiemp_viv_anios integer,entr_telf VARCHAR,entr_cell VARCHAR,pers_ref_telf VARCHAR,pers_ref_cell VARCHAR,num_cuar VARCHAR,num_dorm VARCHAR,contamina_suel_desc VARCHAR,contamina_air_desc VARCHAR,viol_fami integer,dest_fami integer,prob_gra_fam integer,psico_soc integer,aisla integer,sin_escol integer,nin_noescola integer,alcoh integer,droga integer,contamina_agu_desc VARCHAR,intradomi integer,vec_trans integer,anim_viv integer,coc_inhog integer,sedazo integer,mosquit integer,plaguicida integer,aepi integer,abandono integer,ir_uni_sal integer,calle1 varchar, calle2 varchar,telefono varchar,celular varchar,Edificio varchar,Manzana integer,coordenadas varchar,responsable varchar,localidad varchar,institucion varchar,tiempo_transporte integer)"),
    ...
    MORTALIDAD("mortalidad",Mortalidad.class,"CREATE TABLE mortalidad(_id INTEGER PRIMARY KEY  NOT NULL ,  id_par_jh integer,  id_formulario integer,  cedula VARCHAR,  apellidos VARCHAR,  nombres VARCHAR,  fecha_muerte VARCHAR, edad integer,  sexo integer,  causa VARCHAR,  id_cau_mor integer)");
    String tablaName;
    Class aClass;
    String query;
