    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dowload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new GetFormularios(progress,DescargarFormularios.this,url,idsFormulario,fechaIni,fechaFin).execute();
            }
...
*/
    public class GetFormularios extends AsyncTask<String, Void, List<String>> {
        ...
        public GetFormularios(ProgressDialog progress, Context act, String url, String idsFormulario,String fechaIni,String fechaFin) {
